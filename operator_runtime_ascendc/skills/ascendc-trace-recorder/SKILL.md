...
- ascendc-performance-analyzer 的性能测试结果
...
- 结果: 完成
- ascendc-performance-analyzer 执行详情:
...
- 说明: 延迟单位为 ms，按 ascendc-performance-analyzer 的 mean 统计；加速比 =  PyTorch 参考延迟/生成 AscendC 代码延迟 。加速比>0.6性能0.6x pytorch填是，否则填否。性能0.8x pytorch同理。

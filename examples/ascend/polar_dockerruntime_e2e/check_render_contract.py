...
def _parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument("--polar-root", type=Path, default=Path("/home/docker/polar_debug/ProRL-Agent-Server"))
    ...
    parser.add_argument("--readonly-tools-dir", type=Path, default=Path("/home/docker/polar_e2e/readonly_tools"))
...
def main(argv: list[str] | None = None) -> int:
    ...
    _assert_payload_contract(
        payload,
        image=args.image,
        skills_dir=Path("/home/docker/polar_e2e/operator_runtime"),
        readonly_tools_dir=Path("/home/docker/polar_e2e/operator_runtime/tools"),
        pool=expected_pool,
        eval_pool=expected_eval_pool,
        lock_dir=args.lock_dir,
    )

    TopologyConfig.load(args.topology)
    rendered = render_topology_template(args.topology, runtime_args)

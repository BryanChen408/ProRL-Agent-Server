...
POLAR_ROOT="${POLAR_ROOT:-$(cd "${ROOT}/../../.." && pwd)}"
SKILLS_DIR="${POLAR_SKILLS_DIR:-/home/docker/polar_e2e/operator_runtime}"
DEFAULT_TASK_ASSETS="${ROOT}/fixtures/operator_assets"
TASKS_DIR="${POLAR_TASKS_DIR:-${DEFAULT_TASK_ASSETS}/op_tasks}"
TASK_JSONL="${POLAR_TASK_JSONL:-${DEFAULT_TASK_ASSETS}/operator_tasks.jsonl}"

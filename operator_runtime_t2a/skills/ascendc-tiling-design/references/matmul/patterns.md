...
| Ascend 950 | `DAV_3510` | Blaze / tensor_api | 当前运行包不支持 |
...
Ascend 950 / DAV_3510 平台上的 MatMul 类算子采用 Blaze / tensor_api 路径，**不使用** Ascend C `MatmulImpl` / `MatmulApiTiling`。当前运行包未携带该路径的开发资料，不应继续生成实现。

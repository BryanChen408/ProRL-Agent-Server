...
- `ascendc-api-best-practices/`
    - references/api-arithmetic.md
    - references/api-buffer.md
    - references/api-datacopy.md
    - references/api-gathermask.md
    - references/api-gmm.md
    - references/api-host-runtime.md
    - references/api-loaddata.md
    - references/api-matmul.md
    - references/api-mrgsort.md
    - references/api-pipeline.md
    - references/api-precision.md
    - references/api-quickref.md
    - references/api-reduce-pattern.md
    - references/api-reduce.md
    - references/api-repeat-limits.md
    - references/api-restrictions.md
    - references/api-transpose.md
- `ascendc-docs-search/`
    - references/api-index.md
    - references/compatibility.md
    - references/example-catalog.md
    - requirements.txt
    - scripts/ascend_content_fetcher.py
    - scripts/ascend_search_client.py
    - scripts/ascend_search_skill.py
    - scripts/clean_markdown.py
    - scripts/find_api_doc.sh
- `ascendc-precision-debug/`
    - references/ascendc-dumptensor-refs/api-reference.md
    - references/ascendc-dumptensor-refs/error-patterns.md
    - references/ascendc-dumptensor.md
    - references/best-practices.md
    - references/binary-search-debug.md
    - references/case-studies.md
    - references/common-traps.md
    - references/data-comparison.md
    - references/debug-summary-template.md
    - references/diagnosis-workflow.md
    - references/printf-debug.md
    - references/simt-precision-debug.md
    - references/tools-reference.md
    - scripts/error_analysis.py
    - scripts/gen_boundary_test.py
- `ascendc-tiling-design/`
    - references/broadcast/dynamic-ub-broadcast.md
    - references/broadcast/nddma-broadcast.md
    - references/broadcast/onedim.md
    - references/broadcast/patterns.md
    - references/broadcast/ub-broadcast.md
    - references/conversion/patterns.md
    - references/elewise/patterns.md
    - references/elewise/tiling.md
    - references/flashattention/design/_governance.md
    - references/flashattention/design/execution.md
    - references/flashattention/design/resources.md
    - references/flashattention/design/shape.md
    - references/flashattention/foundation/composition.md
    - references/flashattention/foundation/extension_points.md
    - references/flashattention/foundation/fundamentals.md
    - references/flashattention/foundation/roofline.md
    - references/flashattention/implementation_ref.md
    - references/flashattention/patterns.md
    - references/flashattention/specialization/feature_flags.md
    - references/flashattention/specialization/sparse_design.md
    - references/flashattention/subfamilies/base_design.md
    - references/flashattention/subfamilies/quantization_design.md
    - references/matmul/ascendc-api-gmm-tiling.md
    - references/matmul/ascendc-api-matmul-tiling.md
    - …(另有 16 项)
- `npu-arch/`
    - references/npu-arch-guide-triton.md
    - references/npu-arch-guide.md
    - references/npu-hardware-params.md
    - references/simt-arch-guide.md
- `ops-profiling/`
    - references/csv_fields_reference.md
    - references/msprof-guide.md
    - references/msprof-op-guide.md
    - references/optimization_quickref.md
    - scripts/msprof_perf_summary.py
    - scripts/msprof_profile_run.sh
    - scripts/perf_summary.py
- `tilelang2ascend-operator-project-init/`
    - templates/(整棵目录)
    - scripts/detect_ascend_kernel_project.sh
- `tilelang2ascend-precision-tuning/`
    - references/api-reference.md
    - references/debug-workflow-complex.md
    - references/debug-workflow-simple.md
    - references/error-patterns.md
- `tilelang2ascend-tilelang-designer/`
    - references/BlockLevelDesign.md
    - references/TileLangAscendProgrammingGuide.md
    - references/TileLangDebug.md
    - references/attention-patterns/AttentionPatternIndex.md
    - references/attention-patterns/references/head_sharing_pattern.md
    - references/attention-patterns/references/mask_causal_pattern.md
    - references/attention-patterns/references/mla_pattern.md
    - references/attention-patterns/references/page_attention_pattern.md
    - references/attention-patterns/references/sink_pattern.md
    - references/attention-patterns/references/tnd_pattern.md
    - references/attention-patterns/references/topk_kv_sparse_pattern.md
    - scripts/evaluate_tilelang.sh
    - scripts/validate_tilelang_impl.py
    - scripts/verification_tilelang.py
- `tilelang2ascend-translator/`
    - references/AscendCVerification.md
    - references/TileLang-AscendC-API-Mapping.md
    - references/ascendc-sync-guide.md
    - references/ascendc_dynamic_quant_kb.md
    - references/attention-patterns/AttentionPatternIndex.md
    - references/attention-patterns/references/head_sharing_pattern.md
    - references/attention-patterns/references/mask_causal_pattern.md
    - references/attention-patterns/references/mla_pattern.md
    ...
    - references/attention-patterns/references/tnd_pattern.md
    - references/attention-patterns/references/topk_kv_sparse_pattern.md
    - references/dequant_kernel_patterns.md
    - references/dsl2Ascendc.md
    - references/dsl2Ascendc_compute_cube.md
    - references/dsl2Ascendc_compute_cv.md
    - references/dsl2Ascendc_compute_vector.md
    - references/dsl2Ascendc_cross_core_sync.md
    - references/dsl2Ascendc_host.md
    - scripts/build_ascendc.py
    - scripts/evaluate_ascendc.sh
    - scripts/validate_ascendc_impl.py
    - scripts/verification_ascendc.py
